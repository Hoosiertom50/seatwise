    ...
    <div>
      {isOwner && (
        <>
          ...
          <form
            onSubmit={onAdd}
            className="mb-3 grid grid-cols-1 gap-3 rounded-lg border border-neutral-200 p-4 sm:grid-cols-3"
          >
          ...
          {inviteSent && <p className="mb-8 text-sm text-green-700">{inviteSent}</p>}
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm text-neutral-500">
                          ...
                          <span className={i.status === "EXPIRED" ? "text-amber-700" : "text-neutral-500"}>
